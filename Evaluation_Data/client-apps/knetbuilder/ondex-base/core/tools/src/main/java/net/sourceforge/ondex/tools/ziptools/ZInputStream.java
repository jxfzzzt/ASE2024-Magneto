 ...
 *  Copyright (C) 1996-2001 Ronald Tschalaer
 *
...
public class ZInputStream extends FilterInputStream {
    ...
    /**
     * Constructor to wrap an InputStream.
     *
     * @param is the input stream to decompress
     * @throws IOException if the header is malformed
     */
    public ZInputStream(InputStream is) throws IOException {
        super(is);
        parse_header();
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        InputStream in = new ZInputStream(new FileInputStream(args[0]));
