...
/**
 * Metadata constants for the aracyc parser
 *
 * @author peschr
 */
public interface MetaData {

    public static String ORGANISMS_NAME = "Arabidopsis thaliana";
    public static String TAXID = "3702"; //this was an int and causing mapping problems
    ...
    public final static String CV_AraC = "AC";
    ...
    public final static String CV_KNAPSACK = "KNApSAcK";
    public final static String CV_PUBCHEM = "PUBCHEM";
    public final static String CV_CHEBI = "CHEBI";
    public final static String CV_METACYC = "MC";
