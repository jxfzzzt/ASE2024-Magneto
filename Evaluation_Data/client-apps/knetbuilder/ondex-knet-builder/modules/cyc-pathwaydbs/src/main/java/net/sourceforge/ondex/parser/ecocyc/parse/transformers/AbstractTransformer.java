...
import net.sourceforge.ondex.parser.ecocyc.objects.DBName;
...
public abstract class AbstractTransformer {
	...
	public AbstractTransformer(Parser parser) {
		...
		dataSourceMetaC = graph.getMetaData().getDataSource(MetaData.CV_EcoC);
		if (dataSourceMetaC == null) {
			Parser.propagateEventOccurred(new DataSourceMissingEvent(MetaData.CV_EcoC, Parser.getCurrentMethodName()));
		}
