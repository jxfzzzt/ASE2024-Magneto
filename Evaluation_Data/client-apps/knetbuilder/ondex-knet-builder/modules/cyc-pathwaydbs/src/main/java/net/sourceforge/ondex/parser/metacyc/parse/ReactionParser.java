package net.sourceforge.ondex.parser.metacyc.parse;

import java.util.Iterator;

import net.sourceforge.ondex.parser.metacyc.objects.AbstractNode;
import net.sourceforge.ondex.parser.metacyc.objects.Compound;
...
public class ReactionParser extends AbstractParser {
	...
	public void distribute(String key, String value) throws Exception {
		...
		else if (key.equals("REACTION-DIRECTION"))
