...
import net.sourceforge.ondex.parser.metacyc.objects.Enzyme;
import net.sourceforge.ondex.parser.metacyc.objects.Protein;
/**
 * Transforms a net.sourceforge.ondex.parser.metacyc.sink.Enzyme to a Concept.
 * @author peschr
 */
public class EnzymeTransformer extends AbstractTransformer{
	...
	public void nodeToConcept(AbstractNode node) {
		...
		ONDEXConcept concept = graph.getFactory().createConcept(enzyme.getUniqueId(), dataSourceMetaC,
				ccEnzyme, etIMPD);
