...
abstract class Abreviations {
	...
	/**
	 * Class; link to node in the hierarchical classification
	 */
	public final static String classOf  = "CL";

	/**
	 * Structure description
	 */
	public final static String structDesc = "SD";
	
	/**
	 * Factors belonging to this class
	 */
	public final static String binding_factor  = "BF";
	
	/**
	 * PROSITE accession numbers
	 */
	public final static String prosite_accession  = "DR";
