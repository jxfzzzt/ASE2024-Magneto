...
/**
 * Contains mapping from KEGG meta data to ONDEX meta data
 * 
 * @author hindlem
 */
public class MetaData {
	...
	/**
	 * Returns the current data base identifier mapping
	 * 
	 * @param db
	 *            the query database
	...
	public final static String CC_KEGG_ORTHOLOG = "KO";
	...
	public final static String ATTR_NAME_CHEMICAL = "ChemicalStructure";
	public final static String ATTR_NAME_PROTEIN3D = "Protein3dStructure";
