...
public abstract class AbstractTransformer {
	...
	protected DataSource dataSourceBioC = null;
	...
	public AbstractTransformer(Parser parser) {
		...
		dataSourceBioC = graph.getMetaData().getDataSource(Parser.cvToUse);
		if (dataSourceBioC == null) {
			Parser.propagateEventOccurred(new DataSourceMissingEvent(Parser.cvToUse, Parser.getCurrentMethodName()));
		}
	...
	public final void addCommonDetailsToConcept(ONDEXConcept concept,
		...
		concept.createConceptAccession(node.getUniqueId(), this.dataSourceBioC,
				false);
