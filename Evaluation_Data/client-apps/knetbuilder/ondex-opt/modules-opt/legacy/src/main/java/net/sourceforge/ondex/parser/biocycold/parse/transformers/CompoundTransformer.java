...
/**
 * Transforms a net.sourceforge.ondex.parser.biocyc.sink.Compound to a ONDEXConcept.
 * @author peschr
 */
public class CompoundTransformer extends AbstractTransformer{
	...
	public void nodeToConcept(AbstractNode node) {
		...
		ONDEXConcept concept = graph.getFactory().createConcept(compound.getUniqueId(), dataSourceBioC,
				ccComp, etIMPD);
