...
/**
 * Transforms a net.sourceforge.ondex.parser.biocyc.sink.Enzyme to a Concept.
 * @author peschr
 */
public class EnzymeTransformer extends AbstractTransformer{
	...
	public void nodeToConcept(AbstractNode node) {
		...
		ONDEXConcept concept = graph.getFactory().createConcept(enzyme.getUniqueId(), dataSourceBioC,
				ccEnzyme, etIMPD);
