...
/**
 * Transforms a net.sourceforge.ondex.parser.biocyc.sink.Pathway to a Concept.
 * @author peschr
 */
public class PathwayTransformer extends AbstractTransformer {
	...
	public void nodeToConcept(AbstractNode node) {
		...
		ONDEXConcept concept = graph.getFactory().createConcept(pathway.getUniqueId(), dataSourceBioC,
				ccPathway, etIMPD);
