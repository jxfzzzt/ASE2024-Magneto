...
/**
 * Transforms a net.sourceforge.ondex.parser.biocyc.sink.Protein to a Concept.
 * 
 * @author peschr
 */
public class ProteinTransformer extends AbstractTransformer {
	...
	public void nodeToConcept(AbstractNode node) {
		...
		ONDEXConcept concept = graph.getFactory().createConcept(
				protein.getUniqueId(), dataSourceBioC, cc, etIMPD);

		concept.createAttribute(attTaxId, Parser.taxidToUse, false);
