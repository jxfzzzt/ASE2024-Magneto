    ...
    for project_path in client_projects_path:
        ...
        if os.path.exists(result_path):
            try:
                ...
                l.append([project_path, len(susp_dependency_set), len(callchain_result), get_average(callchain_result)])
...
def main():
    for l in process():
       print('\multicolumn{2}{l|}{%s}        & %d & xxx & %d & %.2f & xxx & xxx & xxx & xxx \\\\' %(l[0], l[1], l[2], l[3]))
