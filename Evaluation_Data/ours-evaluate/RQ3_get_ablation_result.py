...
GROUNDTRUTH_DIR = os.path.join(ROOT_DIR, 'groundtruth')
gpt4_dir = CURRENT_DIR
gpt3_dir = os.path.join(ROOT_DIR, 'ours-evaluate-gpt3.5')
wo_seed_template_dir = os.path.join(ROOT_DIR, 'ours-evaluate-wogpt')
wo_directed_fuzzing_dir = os.path.join(ROOT_DIR, 'ours-wo-mutation')
wo_connect_seed_synthesis_dir = os.path.join(ROOT_DIR, 'ours-wo-connect')
scope_1_dir = os.path.join(ROOT_DIR, 'gpt-scope-1')
scope_3_dir = os.path.join(ROOT_DIR, 'gpt-scope-3')
scope_4_dir = os.path.join(ROOT_DIR, 'gpt-scope-4')
