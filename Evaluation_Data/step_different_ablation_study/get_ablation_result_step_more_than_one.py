...
GROUNDTRUTH_DIR = os.path.join(ROOT_DIR, 'groundtruth-step-more-than-one')
gpt4_dir = os.path.join(ROOT_DIR, 'ours-evaluate-step-more-than-one')
gpt3_dir = os.path.join(ROOT_DIR, 'ours-evaluate-gpt3.5-step-more-than-one')
wo_seed_template_dir = os.path.join(ROOT_DIR, 'ours-evaluate-wogpt-step-more-than-one')
wo_directed_fuzzing_dir = os.path.join(ROOT_DIR, 'ours-wo-mutation-step-more-than-one')
wo_connect_seed_synthesis_dir = os.path.join(ROOT_DIR, 'ours-wo-connect-step-more-than-one')
scope_1_dir = os.path.join(ROOT_DIR, 'gpt-scope-1-step-more-than-one')
scope_3_dir = os.path.join(ROOT_DIR, 'gpt-scope-3-step-more-than-one')
scope_4_dir = os.path.join(ROOT_DIR, 'gpt-scope-4-step-more-than-one')
