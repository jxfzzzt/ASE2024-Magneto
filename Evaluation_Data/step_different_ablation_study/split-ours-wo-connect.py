...
def process_public_call_chains(base_dir):
    gpt_scope_dir = os.path.join(base_dir, "ours-wo-connect")
    step_more_than_one_dir = os.path.join(base_dir, "step_different_ablation_study", "ours-wo-connect-step-more-than-one")
    step_equal_one_dir = os.path.join(base_dir, "step_different_ablation_study", "ours-wo-connect-step-equal-one")
