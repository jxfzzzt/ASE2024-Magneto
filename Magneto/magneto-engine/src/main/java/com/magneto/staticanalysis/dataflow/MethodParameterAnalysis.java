...
public class MethodParameterAnalysis extends TaintFlowAnalysis {
    ...
    public MethodParameterAnalysis(@NonNull MethodCall sourceMethod, @NonNull MethodCall triggeredMethod) {
        super();
    ...
    protected void analysisUnit(List<Value> sourceInputParams, SootMethod sootMethod, Unit unit, int depth) {
        ...
        if (unit instanceof JInvokeStmt) {
            ...
            // first check is triggered method
            ...
            if (checkIsTaint(leftOp)) { // taint flow analysis part
                ...
                if (rightOp instanceof JimpleLocal) {
                    ...
                    if (invokedMethod.getDeclaringClass().getName().equals(sourceMethod.getClazz().getName())) {
