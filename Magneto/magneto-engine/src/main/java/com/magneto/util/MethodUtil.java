...
public class MethodUtil {
    ...
    // jarPath --> List<Method>
    public static List<Method> getMethodsFromJar(String jarPath) throws IOException, ClassNotFoundException {
        List<Method> methodList = new ArrayList<>();

        ClassLoader classLoader = JarUtil.loadClassFromJar(jarPath);
        JarFile jarFile = new JarFile(FileUtil.file(jarPath));
